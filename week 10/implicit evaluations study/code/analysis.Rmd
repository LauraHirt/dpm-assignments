...
labeled_scatter_plot <- Axial_histogram + geom_text_repel()
Axial_histogram + geom_text_repel()
...
labeled_scatter_plot_outliers <- Axial_histogram + geom_text_repel(data = labels)
Axial_histogram + geom_text_repel(data = labels)
```
