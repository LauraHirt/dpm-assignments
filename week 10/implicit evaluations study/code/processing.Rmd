...
If it has not already been created, this code writes the codebook template to disk.

TODO

The template should then be filled in manually with descriptions of each variable so that someone else could understand what these variables represent. Codebooks for shared understanding. Describe the variables so that other people understand what they represent. A verbal description of the variable and its usage in the analysis. Write it directly manually into the excel file.
